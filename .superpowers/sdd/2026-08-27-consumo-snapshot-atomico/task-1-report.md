...
- A promoção mantém backups locais e restaura o par anterior se a segunda substituição falhar.
...
- Recuperação entre substituições: `test_restores_the_previous_pair_when_manifest_promotion_fails`
